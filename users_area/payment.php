    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <button class ='text-white border-0 px-5 py-2 my-3 rounded'  style='background-color: #344055;'><a href='order.php?user_id=<?php echo $user_id ?>' class = 'text-light' style='text-decoration:none;'>Proceed Now</a></button>
            </div>
            <div class="col-md-10">
                <?php
                    $email = $_SESSION['email'];
